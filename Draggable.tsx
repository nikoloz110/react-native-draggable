...
interface IProps {
    ...
    onDragRelease?: (e: GestureResponderEvent, gestureState: PanResponderGestureState, bounds: { top: number; left: number; bottom: number; right: number }, reversePosition: () => void) => void;
